...
WebUI.setText(findTestObject('Object Repository/MMdeal01/GenericOR/G_input__deal_type_id'),'Auto Ship Allowance')//ann
...
WebUI.delay(2)
WebUI.setText(findTestObject('Object Repository/MMdeal01/GenericOR/G_input__vendor_id'), '3M COMPANY')
WebUI.delay(2)
WebUI.sendKeys(findTestObject('Input'), Keys.chord('Text String',Keys.ENTER,Keys.TAB))
//WebUI.verifyElementPresent(findTestObject('Object Repository/MMdeal01/GenericOR/G_input_customer'), 5)
WebUI.verifyElementVisible(findTestObject('Object Repository/MMdeal01/GenericOR/G_input_customer'))
