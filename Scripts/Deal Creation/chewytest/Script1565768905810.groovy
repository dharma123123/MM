...
WebUI.navigateToUrl('https://chewytest.marketmedium.net/login')
...
WebUI.setText(findTestObject('Object Repository/MMdeal01/GenericOR/G_input__deal_name'),'YK_test_auto002')
WebUI.delay(2)
...
WebUI.delay(2)
WebUI.setText(findTestObject('MMdeal01/GenericOR/G_input__performance_id'), 'Incremental Volume')
WebUI.sendKeys(findTestObject('Input'), Keys.chord('Text String',Keys.ENTER,Keys.TAB))
