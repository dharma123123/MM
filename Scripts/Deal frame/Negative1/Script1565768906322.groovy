...
WebUI.sendKeys(findTestObject('Input'), Keys.chord('',Keys.ENTER,Keys.TAB))
WebUI.setText(findTestObject('Object Repository/MMdeal01/GenericOR/G_input__deal_start_date'), findTestData('TestData1').getValue(6, 3))
WebUI.delay(1)
WebUI.setText(findTestObject('Object Repository/MMdeal01/GenericOR/G_input__deal_end_date'), findTestData('TestData1').getValue( 6, 1))
WebUI.delay(1)
